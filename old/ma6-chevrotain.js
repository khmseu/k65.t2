...
export function generateSyntaxDiagrams(path) {
...
export function parseAssemblyLine(input) {
...
class ShortVisitor extends BaseCstVisitor {
  maybeVisit(children, param) {
  ...
  subttl(children, param) {
    this.found(children.SubttlDirective, param);
    this.maybeVisit(children.nqstring, param);
  }
  nqstring(children, param) {
  ...
  relational_expr(children, param) {
...
export function in_short(cst) {
  const tokens = [];
  short_visitor.visit(cst, tokens);
  return tokens;
}
//# sourceMappingURL=ma6-chevrotain.js.map
